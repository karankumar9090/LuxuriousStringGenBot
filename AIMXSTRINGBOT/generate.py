...
ask_ques = "**» ▷ Cʜᴏᴏsᴇ ᴛʜᴇ sᴛʀɪɴɢ ᴡʜɪᴄʜ ʏᴏᴜ ᴡᴀɴᴛ ✔️ : :**"
buttons_ques = [
    [
        InlineKeyboardButton("𝖯ʏʀᴏɢʀᴀᴍ", callback_data="pyrogram1"),
        InlineKeyboardButton("𝖯ʏʀᴏɢʀᴀᴍ 𝖵𝟸", callback_data="pyrogram"),
    ],
    [
        InlineKeyboardButton("Tᴇʟᴇᴛʜᴏɴ", callback_data="telethon"),
    ],
    [
        InlineKeyboardButton("𝖯ʏʀᴏɢʀᴀᴍ Bᴏᴛ", callback_data="pyrogram_bot"),
...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    if is_bot:
        ty += " 𝖡𝖮𝖳"
    await msg.reply(f"» Tʀʏɪɴɢ ᴛᴏ sᴛᴀʀᴛ **{ty}** sᴇssɪᴏɴ ɢᴇɴᴇʀᴀᴛᴏʀ...")
    user_id = msg.chat.id
    api_id_msg = await bot.ask(user_id, "Pʟᴇᴀsᴇ sᴇɴᴅ ʏᴏᴜʀ **𝖠𝖯𝖨_𝖨𝖣** ᴛᴏ ᴘʀᴏᴄᴇᴇᴅ.\n\nᴄʟɪᴄᴋ ᴏɴ /skip ғᴏʀ ᴜsɪɴɢ ʙᴏᴛ ᴀᴘɪ.", filters=filters.text)
    ...
    if api_id_msg.text == "/skip":
        ...
        try:
            ...
            await api_id_msg.reply("**𝖠𝖯𝖨_𝖨𝖣** Mᴜsᴛ ʙᴇ ɪɴᴛᴇɢᴇʀ, Sᴛᴀʀᴛ ɢᴇɴᴇʀᴀᴛɪɴɢ ʏᴏᴜʀ sᴇssɪᴏɴ ᴀɢᴀɪɴ.", quote=True, reply_markup=InlineKeyboardMarkup(gen_button))
            return
        api_hash_msg = await bot.ask(user_id, "» Nᴏᴡ ᴘʟᴇᴀsᴇ sᴇɴᴅ ʏᴏᴜʀ **𝖠𝖯𝖨_𝖧𝖠𝖲𝖧** ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ", filters=filters.text)
        if await cancelled(api_hash_msg):
            return
        api_hash = api_hash_msg.text
    if not is_bot:
        t = "» Pʟᴇᴀsᴇ sᴇɴᴅ ʏᴏᴜʀ **PHONE NUMBER** ᴡɪᴛʜ ᴄᴏᴜɴᴛʀʏ ᴄᴏᴅᴇ ғᴏʀ ᴡʜɪᴄʜ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ sᴇssɪᴏɴ \nExᴀᴍᴘʟᴇ : `+910000000000`'"
    else:
    ...
    text = f"**Tʜɪs ɪs ʏᴏᴜʀ {ty} sᴛʀɪɴɢ sᴇssɪᴏɴ** \n\n`{string_session}` \n\n**Gᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :** @LuxuriousStringsGenBot\n🍒 **𝖭𝖮𝖳𝖤 :** ᴅᴏɴ'ᴛ sʜᴀʀᴇ ɪᴛ ᴡɪᴛʜ ʏᴏᴜʀ ɢɪʀʟғʀɪᴇɴᴅ."
    try:
        if not is_bot:
    ...
    await bot.send_message(msg.chat.id, "» Sᴜᴄᴄᴇssғᴜʟʟʏ ɢᴇɴᴇʀᴀᴛᴇᴅ ʏᴏᴜʀ {} sᴛʀɪɴɢ sᴇssɪᴏɴ.\n\nPʟᴇᴀsᴇ ᴄʜᴇᴄᴋ ʏᴏᴜʀ Sᴀᴠᴇᴅ Mᴇssᴀɢᴇs ᴛᴏ ɢᴇᴛ ɪᴛ ! \n\nA sᴛʀɪɴɢ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ ʙʏ @Luxurious_Network ♦".format("ᴛᴇʟᴇᴛʜᴏɴ" if telethon else "ᴩʏʀᴏɢʀᴀᴍ"))
...
async def cancelled(msg):
    if "/cancel" in msg.text:
        ...
        await msg.reply("**» Cᴀɴᴄᴇʟʟᴇᴅ ᴛʜᴇ ᴏɴɢᴏɪɴɢ sᴛʀɪɴɢ sᴇssɪᴏɴ ɢᴇɴᴇʀᴀᴛɪɴɢ ᴘʀᴏᴄᴇss !**", quote=True)
        return True
    else:
        return False
